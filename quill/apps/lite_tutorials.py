"""QuillLite's tutorials: the descriptor the shared window is handed.
...
is the join, and is deliberately the whole of QuillLite's tutorial code.
...
"your saved places grew") -- and none of QuillLite's eight lessons does. That is
...
def _book_path() -> Path | None:
    ...
    ``_doc_candidates`` because QuillLite has no app shell: a document window is
...
def open_tutorials(host: Any, *, slug: str = "") -> None:
    """Help > Tutorials... (Ctrl+Alt+F1): open, or raise, QuillLite's lessons."""
