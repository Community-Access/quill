...
COMMAND_FEATURE_MAP: dict[str, str] = {
    ...
    "format.justify": "core.format",
    "format.line_spacing_single": "core.format",
    "format.line_spacing_one_and_a_half": "core.format",
    "format.line_spacing_double": "core.format",
    "format.grow_font": "core.format",
    "format.shrink_font": "core.format",
    "edit.paste_plain_text": "core.edit",
    ...
    "tools.bring_from_quilllite": "core.profile",
    "view.describe_this_document": "core.accessibility",
    "view.describe_last_change": "core.accessibility",
    "edit.undo_and_say": "core.accessibility",
    "file.new_rich_document": "core.file",
    "file.new_plain_text_document": "core.file",
    "power.describe_character": "core.format",
    "power.describe_character_detail": "core.format",
