; QUILL Social -- THIN ("-Lite") installer.
;
...
MinVersion=10.0
OutputBaseFilename=QUILL-Social-Lite-Setup-{#AppVersion}
...
[Files]
Source: "..\assets\quill-social.ico"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\dist\QuillSocial-shared\QuillSocial.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\dist\QuillSocial-shared\docs\*"; DestDir: "{app}\docs"; Flags: ignoreversion recursesubdirs createallsubdirs skipifsourcedoesntexist

[Icons]
Name: "{group}\{#AppName}"; Filename: "{app}\QuillSocial.exe"; IconFilename: "{app}\quill-social.ico"
Name: "{group}\Uninstall {#AppName}"; Filename: "{uninstallexe}"
Name: "{autodesktop}\{#AppName}"; Filename: "{app}\QuillSocial.exe"; IconFilename: "{app}\quill-social.ico"; Tasks: desktopicon
...
begin
  DownloadPage := CreateDownloadPage(
    ...
    'QUILL Social runs on the shared QuillVille Runtime. If it is not already ' +
    ...
    try
      try
        ...
        if DownloadPage.AbortedByUser then
          MsgBox('The runtime download was cancelled. QUILL Social will ' +
          ...
          MsgBox('The QuillVille Runtime could not be downloaded: ' + GetExceptionMessage + #13#10#13#10 +
                 'You can install it later; QUILL Social will ' +
