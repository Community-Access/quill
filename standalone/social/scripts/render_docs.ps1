...
# quill-radio's render_docs.ps1 (gfm -> html5 -s, gfm -> epub3) so this repo's
# rendered docs are reproducible from source. build_release.ps1 calls this
# before staging the bundled docs\ folder the app's own Help menu opens.
#
