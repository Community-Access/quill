...
- **The Command Palette now says whether Announce Track Titles is on or off.** The palette lists a command's name and offers no checkmark, so the entry read "Announce Track Titles On/Off" whichever way the switch was actually set -- the only way to find out was to throw it. It now reads "Announce Track Titles (currently On)" or "(currently Off)" and retitles itself the moment you toggle it. (#1383)
