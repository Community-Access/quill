...
`PodcastLibrary.apply_show_override`, which clones the show's effective
settings before changing one field -- setting a speed here cannot silently
reset a retention rule set there.
