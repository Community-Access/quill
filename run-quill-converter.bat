@echo off
rem Quill Converter, from this checkout rather than from an installed build.
rem
...
set "QUILL_RUN_MODULE=quill.apps.converter"
set "QUILL_RUN_TAG=run-quill-converter"
