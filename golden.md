...
| MENU-1 | Unified Preferences home | Menus | M | Done | Settings now open through one tabbed front door (`Ctrl+,`) built from the shared settings registry. The five former Tools-menu toggles (announcement trace, Hey QUILL commands, watch folder enabled, AI enabled, Parakeet models) are now registry-driven checkboxes on the relevant Settings tabs (Accessibility, Transcription, Watch, AI); the menu items remain as Settings shortcuts. |
...
| Tier 2 | Flagship experience | 58 | 48 | 10 | OCR-1, OCR-3, OCR-4, AGENT-1, AI-19, SET-2, SET-3, CTX-1, DICT-2, FEAT-19 |
...
| **Total** | All tiers (1.0 + 2.0) | **186** | **82** | **104** | |
...
| --- | --- | --- |
| Tier 2 — Flagship | In progress | SET-2, SET-3, MENU-5, AGENT-1, OCR-1, OCR-3, OCR-4, CTX-1, DICT-2, FEAT-19, DLG-1, AI-19 |
...
| Tier 2 — Flagship | QK-1, QK-2, QK-3, QK-4, QK-5, QK-9, NAV-1, NAV-4, NAV-5, SEL-1, SEL-2, SEL-3, AI-1, AI-6, AI-7, AI-13, AI-14, AI-15, AI-16, AI-17, AI-21, AI-23, WATCH-1, WATCH-2, WATCH-3, WATCH-4, WATCH-5, WATCH-6, WATCH-7, SET-1, SET-4, SET-5, SET-6, SET-7, SHARE-1, SHARE-2, SHARE-3, FLAG-3, FLAG-4, MENU-1, MENU-3, DICT-1, OCR-2, OCR-5 |
