...
**Temporary bookmark:** moved to `Ctrl+Alt+J` so Justify could have Word's key.
Whether it still earns a chord now nine persistent numbered bookmarks exist is a
question for a user, not for the source (P3.1).
