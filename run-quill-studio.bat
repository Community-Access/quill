@echo off
rem Quill Studio, the audio workstation, from this checkout rather than from an installed build.
rem
...
set "QUILL_RUN_MODULE=quill.apps.studio"
set "QUILL_RUN_TAG=run-quill-studio"
