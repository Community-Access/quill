...
- [x] **Hand-held Acceptance Test Book under `docs/release/acceptance/`** — the guided companion to the inventory: 792 step-by-step sign-offs (setup, exact keystrokes, projected outcome, per-sign-off Pass/Fail/Blocked/N-A + Works/Surface-exact/Accessible boxes) plus the 647-line dialog contract, covering all 645 core-editor command ids and the companion apps.
