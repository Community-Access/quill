# support.md — nobody should ever require a GitHub account

*Moved out of `magic.md` on 2026-08-26, unchanged, so that file could take the
EdSharp study. Everything below is still live; the next steps are still next.*
